      ...
      <div className="help">
        ...
        <section className="card card-pad">
          ...
          <ul className="tight">
            ...
            <li><strong>Scam-flagged.</strong> A GoPlus hard signal (honeypot, extreme tax, self-destruct) OR a Honeypot.is simulated buy/sell failure demotes a pair to review — Honeypot.is covers tokens GoPlus never indexed (the BGPT case). A strong reject signal, but you decide.</li>
            <li><strong>Phantom liquidity (deep reserve, ~zero turnover).</strong> A pool can report a huge reserveUsd that&apos;s a fiction — derived from a garbage/honeypot token price — while real 24h volume is a few dollars (e.g. a $92M pool doing $7/day). The 24h-turnover row gives it away. The engine withholds the liquidity credit on such pools: an unidentified one auto-rejects, an identified one routes here for your call. A genuinely deep pool churns meaningful volume.</li>
