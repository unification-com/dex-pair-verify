...
const dataSources = [
    {
        ...
        // defaults.
        defaultThresholds: { minLiquidityUsd: 25000, hardMinLiquidityUsd: 5000 },
        graphql: {
            poolsName: "pairs",
            poolName: "pair",
    ...
    },
    {
        ...
        defaultThresholds: { minLiquidityUsd: 30000, hardMinLiquidityUsd: 5000 },
        graphql: {
            poolsName: "pools",
            poolName: "pool",
    ...
    },
    {
        ...
        defaultThresholds: { minLiquidityUsd: 10000, hardMinLiquidityUsd: 2000 },
        graphql: {
            poolsName: "pairs",
            poolName: "pair",
            reserveUSD: "reserveUSD",
    ...
    },
    {
        ...
        defaultThresholds: { minLiquidityUsd: 5000, hardMinLiquidityUsd: 2000 },
        graphql: {
            poolsName: "pairs",
            poolName: "pair",
            reserveUSD: "reserveUSD",
    ...
    },
    {
        ...
        last_page: 10,
        // Deep venue — floors anchored near the observed p10 (A.8). See uniswap_v2.
        defaultThresholds: { minLiquidityUsd: 35000, hardMinLiquidityUsd: 5000 },
        graphql: {
            poolsName: "pools",
            poolName: "pool",
            reserveUSD: "totalValueLockedUSD",
